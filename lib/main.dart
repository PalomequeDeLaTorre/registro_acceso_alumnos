          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                 ...
                 Container(
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontFamily: 'Jura', // Tipo de letra 'Jura'
                        fontSize: 18),
                ...
                style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(Colors.green), // Cambiar color a verde
                      padding: MaterialStateProperty.all<EdgeInsetsGeometry>(EdgeInsets.symmetric(vertical: 10, horizontal: 20)), // Ajustar el relleno para hacerlo más pequeño
                    ),
                     child: Text(
                       'Get Start',
                         style: TextStyle(
